...
These scripts have a dependency on the outputs from Autorecon and should be run from within the same folder your 'results' folder sits in that Autorecon creates.

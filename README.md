...
These scripts have a dependency on the outputs from Autorecon and **must be run from within the same folder your 'results' folder sits** in that Autorecon creates.
